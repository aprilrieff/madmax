        ...
        <div class="card card-body">
            ...
            <form action="<?php echo URLROOT; ?>/menu/edit/<?php echo $data["item_id"] ?>" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea rows="8" name="item_price" id="item_price" class="form-control form-control-lg <?php echo (!empty($data["item_price_error"])) ? "is-invalid" : ""; ?>"><?php echo $data["item_price"]; ?></textarea>
